/*
 * RobotBuddy — 5x7 Bitmap Font
 * ===============================
 * Monospaced 5x7 pixel font for ASCII 0x20-0x7E (95 characters).
 * Each character is 5 bytes (one byte per row, 5 bits used per row,
 * MSB = leftmost pixel).
 *
 * This is the standard 5x7 font used in many embedded displays.
 *
...
/**
 * @brief 5x7 bitmap font data for ASCII 0x20-0x7E
 *
 * Index: font_5x7[char - 0x20][row]
 * Each byte: bits 7..3 represent pixels left-to-right for that row.
 * Row 0 is the top row of the character.
 */
